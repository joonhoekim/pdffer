...
export default function Page() {
	...
	return (
		...
		<div className="flex flex-col gap-2 justify-center items-center m-8 p-4">
			...
			<div className="flex flex-row gap-2 items-center"><p className="text-sm text-muted-foreground">PoC 목록</p><SearchCheckIcon /></div>
			...
			<Link href="/upload-multiple-files"><Button className="w-full w-max-lg" variant="outline">
				<Upload /> 2. 여러 파일 한번에 업로드 <CheckCheck color="green" />
			</Button></Link>

			<Link href="/filesystem-api-upload"><Button className="w-full w-max-lg" variant="outline">
